...
$config = [
    ...
    'controllers' => [
        ...
        'invokables' => [
            ...
            'list' => 'VuFind\Controller\ListController',
            ...
            'union' => 'VuFind\Controller\UnionController',
    ...
    'service_manager' => [
        ...
        'factories' => [
            ...
            'VuFind\ContentSeriesPluginManager' => 'VuFind\Service\Factory::getContentSeriesPluginManager',
            ...
            'VuFind\ILSTitleCheckoutLogic' => 'VuFind\Service\Factory::getILSTitleCheckoutLogic',
    ...
    'vufind' => [
        ...
        'plugin_managers' => [
            ...
            'content_series' => [
                'factories' => [
                    'syndetics' => 'VuFind\Content\Series\Factory::getSyndetics',
                    'syndeticsplus' => 'VuFind\Content\Series\Factory::getSyndeticsPlus',
                ],
            ],
            'content_summaries' => [
                'factories' => [
            ...
            'recordtab' => [
                ...
                'factories' => [
                    ...
                    'series' => 'VuFind\RecordTab\Factory::getSeries',
        ...
        'recorddriver_tabs' => [
            ...
            'VuFind\RecordDriver\SolrDefault' => [
                'tabs' => [
                    ...
                    'TOC' => 'TOC', 'UserComments' => 'UserComments',
                    'Reviews' => 'Reviews', 'Excerpt' => 'Excerpt',
                    'Preview' => 'preview', 'Series' => 'Series', 'Summaries' => 'Summaries',
...
$staticRoutes = [
    ...
    'LibraryCards/DeleteCard', 'List/Results',
    'MyResearch/Account', 'MyResearch/AddBulk', 'MyResearch/ChangePassword', 'MyResearch/CheckedOut',
    'MyResearch/Delete', 'MyResearch/DeleteList', 'MyResearch/DismissAnnouncement', 'MyResearch/Edit', 'MyResearch/EditList',
