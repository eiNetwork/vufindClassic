...
class AbstractRecord extends AbstractBase
{
    ...
    public function addcommentAction()
    {
        ...
        if (!empty($comment)) {
            ...
            $this->flashMessenger()->addMessage('add_comment_success', 'info');
        } else {
    ...
    public function deletecommentAction()
    {
        ...
        if (!is_null($id) && $table->deleteIfOwnedByUser($id, $user)) {
            $this->flashMessenger()->addMessage('delete_comment_success', 'info');
        } else {
    ...
    public function smsAction()
    {
        ...
        if ($this->formWasSubmitted('submit', $view->useRecaptcha)) {
            ...
            try {
                ...
                $this->flashMessenger()->addMessage('sms_success', 'info');
                return $this->redirectToRecord();
            } catch (MailException $e) {
                $this->flashMessenger()->addMessage($e->getMessage(), 'error');
            }
