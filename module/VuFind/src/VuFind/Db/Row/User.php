    ...
    \ZfcRbac\Identity\IdentityInterface
{
     ...
     *
     * @param string $preferredLibrary New preferred library to store.
     *
     * @return mixed           The output of the save method.
     */
    public function changePreferredLibrary($preferredLibrary)
    {
        $this->preferred_library = $preferredLibrary;
        return $this->save();
    }

    /**
     * Change alternate library.
     *
     * @param string $alternateLibrary New alternate library to store.
     *
     * @return mixed           The output of the save method.
     */
    public function changeAlternateLibrary($alternateLibrary)
    {
        $this->alternate_library = $alternateLibrary;
        return $this->save();
    }

    /**
     * Change splitEcontent.
     *
     * @param string $splitEcontent New splitEcontent to store.
     *
     * @return mixed           The output of the save method.
     */
    public function changeSplitEcontent($splitEcontent)
    {
        $this->splitEcontent = $splitEcontent;
        return $this->save();
    }
